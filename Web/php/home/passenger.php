...
<body>
    <div class="sidebar">
        ...
        <h1>Welcome,
            <?php echo htmlspecialchars($_SESSION['givenName']) . " " . htmlspecialchars($_SESSION['familyName']); ?>!
        </h1>
        <img src="<?php echo htmlspecialchars($_SESSION['avatar']); ?>" alt="Profile Picture" width="100"
            style="border-radius:100px;" />
        <?php elseif ($loginType === 'facebook'): ?>
        <h1>Welcome,
            <?php echo htmlspecialchars($_SESSION['userData']['first_name']) . " " . htmlspecialchars($_SESSION['userData']['last_name']); ?>!
        </h1>
        <img src="<?php echo htmlspecialchars($_SESSION['userData']['picture']['url']); ?>" alt="Profile Picture"
            width="100" style="border-radius:100px;" />
        <?php elseif ($loginType === 'form'): ?>
        <!-- <pre>print_r($_SESSION);</pre> -->
        <h1>Welcome,
            <?php echo htmlspecialchars($_SESSION['firstName']) . " " . htmlspecialchars($_SESSION['lastName']); ?>!
        </h1>
        <img src="<?php echo htmlspecialchars($_SESSION['avatar']); ?>" alt="Picture not found!" width="100"
            style="border-radius:100px;" />
        <?php endif; ?>
        ...
        <div class="logout nav-link"><a href='/logout'>Logout</a></div>
    </div>
    <div class="content">
